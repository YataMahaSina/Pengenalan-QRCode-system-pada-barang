...
class QRCodeDetector:
    ...
    def draw_control_panel_right(self, frame):
        ...
        # ==================== PANEL MODE AKTIF ====================
        mode_panel_height = 90  # Diperbesar sedikit
        cv2.rectangle(frame, 
                     (panel_x + 10, y_offset), 
        ...
        # Mode indicator dengan background yang lebih besar
        mode_bg_x = panel_x + panel_width - 140  # Lebih ke kiri
        mode_bg_width = 120
        mode_bg_height = 50
        
        cv2.rectangle(frame, 
                     (mode_bg_x, y_offset + 15),  # Jarak dari atas lebih besar
        ...
        # Hitung ukuran teks yang sesuai
        mode_font_scale = 0.9
        mode_thickness = 2
        ...
        # ==================== PANEL COUNTER ====================
        counter_panel_height = 120  # Diperbesar
        cv2.rectangle(frame, 
                     (panel_x + 10, y_offset), 
        ...
        cv2.putText(frame, masuk_label, (masuk_label_x, y_offset + 65),  # Posisi lebih atas
        ...
        # Posisi angka di bawah teks dengan jarak yang cukup
        masuk_count_x = masuk_bg_x + (masuk_width - masuk_count_size[0]) // 2
        masuk_count_y = y_offset + 40 + masuk_height - 10  # 10px dari bawah
        ...
        cv2.putText(frame, keluar_label, (keluar_label_x, y_offset + 65),  # Posisi lebih atas
        ...
        keluar_count_y = y_offset + 40 + masuk_height - 10  # 10px dari bawah
        ...
        cv2.putText(frame, status_text, (panel_x + 30, y_offset + 90), 
...
def main():
    ...
    print("=" * 50)
    print("SISTEM TRACKING BARANG QR CODE")
    print("=" * 50)
    print("\nPETUNJUK PENGGUNAAN:")
    ...
    print("Posisi berubah TIDAK menambah waktu tampil")
    print("=" * 50)
    ...
    while True:
        ...
        # Tampilkan frame
        cv2.imshow('QR Tracking System - Kamera Live + Panel Kontrol', output_frame)
